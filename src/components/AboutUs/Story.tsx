...
import img1 from "@/assets/aboutUs/story1.jpeg";
import img2 from "@/assets/aboutUs/story2.jpeg";

const Story = () => {
  return (
    <div className="flex flex-col   items-center gap-[56px] border-b  border-[#D5C0C5] justify-center py-4 md:py-8   md:mx-0 md:px-8">
      <div className="flex justify-between flex-col md:flex-row md:items-center px-4 w-full">
